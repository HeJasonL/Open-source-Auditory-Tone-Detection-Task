...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\W2032175\\Documents\\GitHub\\Open-source-Auditory-Tone-Detection-Task\\Headphone Calibration\\headphone_calibration_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='This experiment has been created to help you calibrate your headphones. \n\nIt is recommended that you do this in a quiet room, preferrably an anechoic chamber\n\n\nIt is assumed that your dB SPL meter is already set up and running\n\nIt is also assumed that the sensitivity (dB / 1 V RMS) of your headphones stated by the manufacturer is accurate.\n\n\nThere is no assumption made regarding the accuracy of your db SPL meter or your testing environment\n\n\nPress space to continue',
    font='Arial',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Please sure you have set and recorded your system volume to ~70%\n\nAlso ensure that your Focusrite Scarlett Solo is set to maximum volume and that direct monitoring is OFF\n\nPress space to continue\n',
    font='Arial',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='On the next slide, you will be presented with a value between 0 and 1.\n\nYour job is to adjust the value until you read exactly 113 on your db SPL meter\n\nPress the up arrow to increase the value and the down arrow to decrease the value.\nThe value is consistent with volume, such that lower values are quieter and higher values are louder.\n\nSpend some time doing this and do not settle for any value other than 113 (e.g., if you see 112.9, press down!).\n\nThe jumps in volume will start out big and eventually become small. This allows you to make large changes early on and fine tune the value once you are close to 113.\n\nAfter the first 10 changes, the text will turn green, only then will you be able to continue.\n\nIt is recommended that you wear ear plugs during this process as 113 db SPL is quite loud and may damage your hearing with repeated exposure.\n\nPress space to start',
    font='Arial',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
sound_1 = sound.Sound('Noise_BP_600_1400.wav', secs=-1, stereo=True, hamming=True,
    name='sound_1')
sound_1.setVolume(1.0)
key_resp = keyboard.Keyboard()
question_text = visual.TextStim(win=win, name='question_text',
    text="'Does your db SPL meter read 113 db SPL?'\n\nPress 'up' to increase volume or 'down' to decrease volume\n\nOnce the text above turns green and your db SPL meter reads 113 db SPL press 'c'",
    font='Helvetica',
...
text_6 = visual.TextStim(win=win, name='text_6',
    text='The PsychoPy value that produces\n113 dB SPL on your headphones is:\n',
    font='Arial',
    pos=(0, 0.3), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-1.0);
last_level_text = visual.TextStim(win=win, name='last_level_text',
    text='default text',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
...
text_5 = visual.TextStim(win=win, name='text_5',
    text='Please record this exact value \n\nPress e to end',
    font='Arial',
    pos=(0, -0.3), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
startComponents = [key_resp_2, press_space, title_text]
...
_key_resp_4_allKeys = []
# keep track of which components have finished
instr2Components = [text_3, key_resp_4]
...
_key_resp_5_allKeys = []
# keep track of which components have finished
instr3Components = [text_4, key_resp_5]
...
trials = data.StairHandler(startVal=0.1, extraInfo=expInfo,
    stepSizes=[0.3, 0.3, 0.2, 0.2, 0.1, 0.1, 0.05, 0.05, 0.01, 0.01], stepType='log',
    nReversals=0, nTrials=1000, 
    nUp=1, nDown=1,
    minVal=0, maxVal=1,
...
for thisTrial in trials:
    ...
    if trials.thisTrialN > 10:
        level_text_colour = 'LightGreen'
    else:
            level_text_colour = 'white'
    
    
    sound_1.setSound('Noise_BP_600_1400.wav', secs=30, hamming=True)
    sound_1.setVolume(level, log=False)
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    level_text.setColor(level_text_colour, colorSpace='rgb')
    level_text.setText(level)
    # keep track of which components have finished
    trialComponents = [sound_1, key_resp, question_text, level_text]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if key_resp.status == STARTED and not waitOnFlip:
            theseKeys = key_resp.getKeys(keyList=['down', 'up', 'c'], waitRelease=False)
    ...
    for thisComponent in trialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    if key_resp.keys == 'c' and level_text_colour == 'LightGreen':
...
# update component parameters for each repeat
print(level)
last_level_text.setText(level)
key_resp_6.keys = []
key_resp_6.rt = []
_key_resp_6_allKeys = []
# keep track of which components have finished
doneComponents = [text_6, last_level_text, text_5, key_resp_6]
...
while continueRoutine:
    ...
    # *last_level_text* updates
    if last_level_text.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        last_level_text.frameNStart = frameN  # exact frame index
        last_level_text.tStart = t  # local t and not account for scr refresh
        last_level_text.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(last_level_text, 'tStartRefresh')  # time at next scr refresh
        last_level_text.setAutoDraw(True)
    ...
    if key_resp_6.status == STARTED and not waitOnFlip:
        theseKeys = key_resp_6.getKeys(keyList=['e'], waitRelease=False)
        _key_resp_6_allKeys.extend(theseKeys)
        if len(_key_resp_6_allKeys):
            key_resp_6.keys = _key_resp_6_allKeys[-1].name  # just the last key pressed
            key_resp_6.rt = _key_resp_6_allKeys[-1].rt
            # was this correct?
            if (key_resp_6.keys == str('e')) or (key_resp_6.keys == 'e'):
                key_resp_6.corr = 1
            else:
                key_resp_6.corr = 0
            # a response ends the routine
...
thisExp.addData('last_level_text.started', last_level_text.tStartRefresh)
thisExp.addData('last_level_text.stopped', last_level_text.tStopRefresh)
