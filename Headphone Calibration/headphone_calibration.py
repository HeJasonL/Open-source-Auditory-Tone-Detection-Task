...
text_2 = visual.TextStim(win=win, name='text_2',
    text="This experiment has been created to help you calibrate your headphones. \n\nIt assumes that your dB SPL meter setup and running. \n\nThe accuracy of this process will depend on the specifications of your dB SPL meter (e.g., it's sensitivity and proximity to headphones).\n\nPress space to continue",
    font='Arial',
...
text_6 = visual.TextStim(win=win, name='text_6',
    text='The PsychoPy value that produces 113 dB SPL on your headphones is:\n',
    font='Arial',
