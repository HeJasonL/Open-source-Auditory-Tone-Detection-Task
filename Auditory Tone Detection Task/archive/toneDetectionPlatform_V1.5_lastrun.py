...
expInfo = {'participant': '', 'Session': '1', 'Tone Length': ['Short', 'Long'], 'Condition': ['Quiet', 'Simultaneous', 'Backward']}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath="/Users/jasonhe/Documents/Documents - Jason's iCloud/Work/GitHub/Open-source Auditory Tone Detection (OSATD) Task/Auditory Tone Detection Task/toneDetectionPlatform_V1.5_lastrun.py",
