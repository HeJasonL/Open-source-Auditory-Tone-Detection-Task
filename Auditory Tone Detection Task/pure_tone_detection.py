...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath="/Users/jasonhe/Documents/Documents - Jason's iCloud/Work/Projects/JHE/Open-source-Auditory-Tone-Detection-Task/Auditory Tone Detection Task/pure_tone_detection.py",
