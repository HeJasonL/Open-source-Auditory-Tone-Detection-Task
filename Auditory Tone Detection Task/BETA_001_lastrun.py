...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonhe/Dropbox/Documents/Projects/Auditory detection tasks AIMS Project/Auditory Tone Detection Task/BETA_001_lastrun.py',
...
Feedback_text = visual.TextStim(win=win, name='Feedback_text',
    ...
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='[Feedback_textColour]', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
...
for thisTrial in trials:
    ...
    if Question_Response.keys[0] != '1':
        [Feedback_textColour] = "green" # don't even start this routine
    # keep track of which components have finished
