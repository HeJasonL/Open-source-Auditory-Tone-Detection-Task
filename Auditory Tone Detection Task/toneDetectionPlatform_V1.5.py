...
expName = 'toneDetectionPlatform_V1.5'  # from the Builder filename that created this script
expInfo = {'Participant': '', 'Session': '1', 'Tone Length': ['Short', 'Long'], 'Condition': ['Quiet', 'Simultaneous', 'Backward'], 'Calibration Value': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath="/Users/jasonhe/Documents/Documents - Jason's iCloud/Work/GitHub/Open-source Auditory Tone Detection (OSATD) Task/Auditory Tone Detection Task/toneDetectionPlatform_V1.5.py",
