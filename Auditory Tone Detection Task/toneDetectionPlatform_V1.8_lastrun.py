...
expName = 'toneDetectionPlatform_V1.8'  # from the Builder filename that created this script
expInfo = {'Participant': '', 'Session': '1', 'Condition': ['Quiet', 'Simultaneous', 'Backward'], 'Calibration': '0.8912509381337447', 'Practice': ['Yes', 'No'], 'Instructions': ['Yes', 'No']}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\W2032175\\Documents\\GitHub\\Open-source-Auditory-Tone-Detection-Task\\Auditory Tone Detection Task\\toneDetectionPlatform_V1.8_lastrun.py',
