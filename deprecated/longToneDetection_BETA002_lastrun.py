...
expName = 'longToneDetection_BETA002'  # from the Builder filename that created this script
expInfo = {'participant': '', 'session': '001', 'Tone Length': ['Short', 'Long'], 'Condition': ['Temporal Centre', 'Backward Masking', 'Simultaneous Onset', 'Simultaneous Delay', 'Forward Masking']}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonhe/Dropbox/Documents/GitHub/Open-source Auditory Tone Detection (OSATD) Task/Auditory Tone Detection Task/longToneDetection_BETA002_lastrun.py',
