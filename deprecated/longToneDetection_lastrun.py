...
expName = 'longToneDetection'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonhe/Dropbox/Documents/GitHub/Open-source Auditory Tone Detection (OSATD) Task/Auditory Tone Detection Task/longToneDetection_lastrun.py',
...
trials = data.TrialHandler(nReps=15, method='random', 
    ...
    trialList=data.importConditions('longToneConditions.xlsx'),
