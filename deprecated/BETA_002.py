...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonhe/Dropbox/Documents/Projects/Auditory detection tasks AIMS Project/Auditory Tone Detection Task/BETA_002.py',
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    Feedback_text.setColor(feedbackColour, colorSpace='rgb')
    # only run the routine if the response was a 1:
    if Question_Response.keys[0] != '1':
        feedbackColour = green #make feedback green
