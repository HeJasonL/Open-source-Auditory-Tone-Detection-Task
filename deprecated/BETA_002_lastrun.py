...
expName = 'BETA_002'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonhe/Dropbox/Documents/Projects/Auditory detection tasks AIMS Project/Auditory Tone Detection Task/BETA_002_lastrun.py',
...
for thisTrial in trials:
    ...
    print("Probe was presented in the interval:", interval)
    # keep track of which components have finished
    ...
    # print(type(Question_Response.keys[0]), type(str(interval)))
    # print(Question_Response.keys[0] == str(interval))
    if Question_Response.keys[0] == str(interval):
       Feedback_text.setColor([0,intensity,0], colorSpace='rgb') #GREEN
       print('Participant was correct')
       intensity = intensity + 0.1
       print(intensity)
    elif Question_Response.keys[0] != str(interval):
       Feedback_text.setColor([1,0,0], colorSpace='rgb') #RED 
       print('Participant was incorrect')
       intensity = intensity - 0.1
       print(intensity)
