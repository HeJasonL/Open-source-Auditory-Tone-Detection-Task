...
expName = 'briefToneDetection'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonhe/Dropbox/Documents/GitHub/Open-source Auditory Tone Detection (OSATD) Task/Auditory Tone Detection Task/briefToneDetection_lastrun.py',
...
trials = data.TrialHandler(nReps=15, method='random', 
    ...
    trialList=data.importConditions('briefToneConditions.xlsx'),
...
for thisTrial in trials:
    ...
    if toneVolume <= 0: #if tone volume is equal or less than 0
        toneVolume == 0 #make it zero 
