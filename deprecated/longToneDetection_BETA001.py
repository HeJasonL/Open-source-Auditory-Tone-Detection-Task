...
expInfo = {'participant': '', 'session': '001', 'version':''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jasonhe/Dropbox/Documents/GitHub/Open-source Auditory Tone Detection (OSATD) Task/Auditory Tone Detection Task/longToneDetection_BETA001.py',
...
for thisTrial in trials:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    probeTone1.setSound('1000', secs=probe1Duration)
    probeTone1.setVolume(toneVolume, log=False)
    probeTone2.setSound('1000', secs=probe2Duration)
    ...
    while continueRoutine:
        ...
        frameRemains = probe1Onset + probe1Duration- win.monitorFramePeriod * 0.75  # most of one frame period left
        if probeTone1.status == STARTED and t >= frameRemains:
            ...
            if probe1Duration > 0.5:  # don't force-stop brief sounds
                probeTone1.stop()
        ...
        frameRemains = probe2Onset + probe2Duration- win.monitorFramePeriod * 0.75  # most of one frame period left
        if probeTone2.status == STARTED and t >= frameRemains:
            ...
            if probe2Duration > 0.5:  # don't force-stop brief sounds
                probeTone2.stop()
    ...
    # update component parameters for each repeat
    if questionResponse.keys[0] == str(corrAns):
       #Adjust tone volume
    ...
    elif questionResponse.keys[0] != str(corrAns):
       #Adjust tone volume
